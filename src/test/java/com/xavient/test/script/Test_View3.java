...
public class Test_View3 extends BaseClass implements DashBoardView {
	...
	public void view3_validate_table_data() {
		...
		helper.validate_table_names(driver.findElement(view3_curr_data),
				"Test_View3", "view3_curr_data");
		helper.validate_table_columns(view3_curr_data_table, driver, "",
				"Test_View3", "view3_curr_data_table");

		helper.validate_table_names(driver.findElement(view3_today_data),
				"Test_View3", "view3_today_data");
		helper.validate_table_columns(view3_today_data_table, driver, "",
				"Test_View3", "view3_today_data_table");

		helper.validate_table_names(
				driver.findElement(view3_curr_agent_stats_tbl), "Test_View3",
				"view3_curr_agent_stats_tbl");
		helper.validate_table_columns(view3_curr_agent_stats_col, driver, "",
				"Test_View3", "view3_curr_agent_stats_col");

		helper.validate_table_names(driver.findElement(view3_agent_details),
				"Test_View3", "view3_agent_details");
		helper.validate_table_columns(view3_Agent_table_data_start, driver,
				view3_Agent_table_data_end, "Test_View3",
				"view3_Agent_table_data");
		logger.info("-----End of test case execution for :view3_validate_table_data------");
	}

	/**
	 * @author NMakkar Method is validating static data set of line graph
	 */
	...
	public void view3_validate_line_graph_data() {
		...
		wait.until(ExpectedConditions.visibilityOf(driver
				.findElement(view3_line_graph_title)));

		// Validating all static data.
		helper.validate_table_names(driver.findElement(view3_line_graph_title),
				"Test_View3", "view3_line_graph_title");
		helper.validate_table_names(
				driver.findElement(view3_line_graph_y_axis), "Test_View3",
				"view3_line_graph_y_axis");
		helper.validate_table_names(
				driver.findElement(view3_line_graph_header), "Test_View3",
				"view3_line_graph_header");
		helper.validate_list_data_axis(view3_graph_x_axis, driver,
				"Test_View3", "view3_line_graph_x_axis");
	...
	public void view3_validate_bar_graph_data() {
		...
		wait.until(ExpectedConditions.visibilityOf(driver
				.findElement(view3_bar_graph_title)));

		// Validating all static data.
		helper.validate_table_names(driver.findElement(view3_bar_graph_title),
				"Test_View3", "view3_bar_graph_title");
		helper.validate_table_names(driver.findElement(view3_bar_graph_y_axis),
				"Test_View3", "view3_bar_graph_y_axis");
		helper.validate_table_names(driver.findElement(view3_bar_graph_header),
				"Test_View3", "view3_bar_graph_header");
		helper.validate_list_data_axis(view3_graph_x_axis, driver,
				"Test_View3", "view3_bar_graph_x_axis");
		logger.info("-----End of test case execution for :view3_validate_bar_graph_data------");
	}

	/**
	 * @author guneet Method is validating table sorting
	 */
	...
	public void view3_table_sorting() {
		...
		int tableComtentCount = helper.getWebelentSize(
				view3_agent_details_data, driver);
		logger.info("Agent details table ");
		int totalTableCount = helper.getWebelentSize(
				By.xpath(view3_Agent_table_data_start), driver);
		if (tableComtentCount > 0) {
			for (int i = 1; i <= totalTableCount; i++) {
				for (int j = 0; j < 2; j++) {
					driver.findElement(
							By.xpath(view3_Agent_table_data_start + "[" + i
									+ "]" + view3_Agent_table_data_sort_arrow))
									.click();
					for (int i1 = 1; i1 <= tableComtentCount; i1++) {
						List<WebElement> el = driver.findElements(By
								.xpath("//div[@class='ui-grid-canvas']/div["
										+ i1 + "]//div[@role='gridcell']/div"));
	...
	/**
	 * @author guneet Method is validating table pagination
	 */
	...
	public void view3_table_pagination() {
		...
		Assert.assertEquals(" items per page",
				driver.findElement(pagerPageDropText).getText());

		count = count.split(" ")[2];
		if (Integer.parseInt(count) > 5) {

			// Checking pagination first and previous is disabled
			Assert.assertEquals("true", driver.findElement(pagerFirst)
					.getAttribute("disabled"),
					"Pagination first must be disabled");
			Assert.assertEquals("true", driver.findElement(pagerPrevious)
					.getAttribute("disabled"),
					"Pagination Previous must be disabled");

			// clicking pagination last button
			driver.findElement(pagerLast).click();

			Assert.assertEquals("true", driver.findElement(pagerLast)
					.getAttribute("disabled"),
					"Pagination Last must be disabled");
			Assert.assertEquals("true", driver.findElement(pagerNext)
					.getAttribute("disabled"),
					"Pagination Next must be disabled");
			...
			for (int i = 0; i < dCount.size() - 1; i++) {
				...
				Assert.assertEquals(dropList[i], Integer.parseInt(select2
	...
	public void view3_validate_piechart_data() {
		...
		wait.until(ExpectedConditions.visibilityOf(driver
				.findElement(view3_line_graph_title)));
		helper.validate_table_names(
				driver.findElement(view3_piechart_graph_header), "Test_View3",
				"view3_pie_chart_header");
		wait.until(ExpectedConditions.visibilityOf(driver
				.findElement(view3_piechart_labels)));
		helper.validate_list_data(view3_piechart_labels, driver, "Test_View3",
				"view3_piechart_labels");
		helper.validate_table_names(
				driver.findElement(view3_piechart_Total_Agents_label),
				"Test_View3", "view3_piechart_Total_Agents_label");
		helper.validate_table_names(
				driver.findElement(view3_piechart_Agents_Staffed_label),
				"Test_View3", "view3_piechart_Agents_Staffed_label");
	}
	...
	public void view3_COEs_table_data_validation() {
		...
		// Table 3 - Data .
		List<WebElement> data_of_table3 = driver
				.findElements(view3_COEs_table_data_val);
		// Table 3 - Columns
		List<WebElement> col_of_table3 = driver.findElements(By
				.xpath(view3_curr_agent_stats_col));
		// Table 1 - Data
		List<WebElement> updated_col_table1 = driver
				.findElements(view3_Current_table_data_val);
		// Table 1 - Colums
		List<WebElement> col_of_table1 = driver.findElements(By
				.xpath(view3_curr_data_table));

		// Adding Column data from another table.
		data_of_table3 = helper.modify_cols_data_of_table(col_of_table1,
				data_of_table3, updated_col_table1, check_text, true);
